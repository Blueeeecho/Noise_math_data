...
for i in "${!TRAIN_TEMP_LIST[@]}"; do
    ...
    sbatch \
        ...
        --export="ALL,CASE_NAME=${ACRONYM},PROMPT_VERSION=${ACRONYM},BASE_MODEL_PATH_OVERRIDE=${MODEL_PATH},MODEL_NAME=${MODEL_NAME},TOTAL_EPOCHS=${TOTAL_EPOCHS},SHARE_EVAL_JSONL_TO_ALL_LOGS=1,SHARED_EVAL_DATASETS=global_training_summary.csv,SHARED_ALL_LOG_DIR=${SLURM_LOG_DIR},INCLUDE_STEP_SCORE_RUBRIC=1" \
