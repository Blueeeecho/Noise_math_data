        ...
        try:
            ...
            for i in tqdm(range(len(sample_outputs)), desc="Extracting Answers", file=sys.stdout, dynamic_ncols=True):
                ...
                record = {
                    ...
                    "process_gate": extra_value("process_gate"),
                    "format_gate": extra_value("format_gate"),
                    "raw_good_term": extra_value("raw_good_term"),
                    "raw_bad_term": extra_value("raw_bad_term"),
                    "raw_process_term": extra_value("raw_process_term"),
                    "acc_contrib": extra_value("acc_contrib"),
                    "process_contrib": extra_value("process_contrib"),
                    "format_contrib": extra_value("format_contrib"),
