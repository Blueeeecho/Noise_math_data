...
def parse_args():
    ...
    parser.add_argument("--prompt_version", type=str, default=os.environ.get("PROMPT_VERSION", "case_1"), choices=["case_1", "case_2"])
...
def main():
    ...
    for item in data:
        messages = build_messages(item["question"], args.prompt_version)
