...
python3 -m verl.trainer.main_ppo \
    ...
    +custom_reward_function.reward_kwargs.good_step_cap=${good_step_cap} \
    +custom_reward_function.reward_kwargs.bad_step_cap=${bad_step_cap} \
    +custom_reward_function.reward_kwargs.length_penalty_start=${length_penalty_start} \
    +custom_reward_function.reward_kwargs.length_penalty_per_step=${length_penalty_per_step} \
